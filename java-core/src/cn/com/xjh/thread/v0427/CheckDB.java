...
/** * 比较新旧数据库 *  * 显示新增的表名称 * 显示被修改的列(名称和类型) */
public class CheckDB {
    public static void main(String[] args) {
        ...
        // 新增的表
        List updateColList = new ArrayList();
        // 修改已有表的列
        // compare with
        for (Object object1 : map1.keySet()) {
            if (map2.containsKey(object1)) {
                List list1 = (ArrayList) map1.get(object1);
                List list2 = (ArrayList) map2.get(object1);
                for (Object col1 : list1) {
    ...
    static class DataBase {
        ...
        public DataBase(String driveName, String userName, String password,String url) {
            linkDataBase(driveName);        createConnection(userName, password, url);
        }
        /**
         * 加载数据库的驱动程
         *
